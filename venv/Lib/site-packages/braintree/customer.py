...
class Customer(Resource):
    ...
    def __init__(self, gateway, attributes):
        ...
        if "mainpass_cards" in attributes:
            self.mainpass_cards = [MainpassCard(gateway, mainpass_card) for mainpass_card in self.mainpass_cards]
            self.payment_methods += self.mainpass_cards
